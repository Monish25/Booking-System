...
def collect2(a,b):
        ...
        sql_select_query = """select * from rail where T_Board = %s and T_Dest = %s"""
...
tree.heading("#1", text="Train No")
tree.heading("#2", text="Train Name")
tree.heading("#3", text="Train Boarding")
tree.heading("#4", text="Train Destination")
tree.heading("#5", text="Train Dist")
tree.heading("#6", text="Train Fare")
tree.heading("#7", text="Train Dept")


tree.column("#1",minwidth=0,width=55)
tree.column("#2",minwidth=0,width=95)
tree.column("#3",minwidth=0,width=95)
tree.column("#4",minwidth=0,width=100)
tree.column("#5",minwidth=0,width=60)
tree.column("#6",minwidth=0,width=90)
tree.column("#7",minwidth=0,width=75)
